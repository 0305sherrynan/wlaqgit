...
function strEnc(data,firstKey,secondKey,thirdKey){
   ...
   */
   ...
   // 将64位的位串转换为它的16进制形式，共由16个字符（4位二进制对应一个16进制字符）。
   // 主要是为了显示分组数据
   ...
   */
   ...
   function sBoxPermute(expandByte){
      ...
      var i=0,j=0;
      i = expandByte[m*6+0]*2+expandByte[m*6+5];  // 首尾两位数据一起组成行坐标地址，
      j = expandByte[m * 6 + 1] * 2 * 2 * 2     // 中间四位组成列坐标地址，
